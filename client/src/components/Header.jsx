...
const Header = () => {
  return (
    <div className='flex items-center judtify-between max-sm:flex-col-reverse gap-y-10 px-4 my-10 lg:px-44 sm:mt-20'>
        {/* {--------- Left Side ---------} */}
        <div>
            ...
            <p className='my-6 text-[-15px] 2xl:text-gray-500 '>Lorem Ipsum is simply dummy text of the printing and typesetting industry. <br className='max-md:hidden' />
